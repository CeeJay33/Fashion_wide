<template>
      <div class="lay_color" >
          <div class="chip"><img src="http://localhost:80/Fashion2/Fashion/profile/fashion-design-logo-template-6ecc250291e1e13cba71fb14e4700698_screen.jpg"
              loading="lazy" width="96" height="96"></div>
          <div class="stories">
            <ul class="des">
              <li><strong>Category: </strong>Fashion Desiner</li>
              <li><strong>Experience: </strong>3 years</li>
            </ul>
            <div class="images">
              <div class="image"><img src="http://localhost:80/Fashion2/Fashion/uploads/IMG-20230529-WA0043.jpg" alt=""></div>
